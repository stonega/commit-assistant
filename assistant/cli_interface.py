...
# Constants
WELCOME_MESSAGE = f"Commit Assistant v{VERSION}\nAnalyze and organize your commits"
    ...
    def display_commit_groups(self, groups: List[Dict]) -> List[Dict]:
        ...
        for i, group in enumerate(groups, 1):
            ...
            try:
                ...
                console.print(
                    "[yellow]Non-interactive environment, accepting this commit by default[/yellow]"
                )
                approved_groups.append(group)
